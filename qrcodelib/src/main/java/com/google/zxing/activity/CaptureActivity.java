    ...
    private void addViewListener() {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int i = v.getId();
                if (i == R.id.capture_close) {
                    onBackPressed();
                } else if (i == R.id.chose_image) {
        ...
        findViewById(R.id.capture_close).setOnClickListener(listener);
        findViewById(R.id.chose_image).setOnClickListener(listener);
    }
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result != null) {
                                ...
                                Toast.makeText(CaptureActivity.this, "未识别二维码", Toast.LENGTH_SHORT).show();
