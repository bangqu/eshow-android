...
public class EditSingleLineDialog extends Dialog {
    ...
    public EditSingleLineDialog(Context context, String title, OnOperaClickedListener listener) {
        this(context, title, -1, listener);
    }

    public EditSingleLineDialog(Context context, String title, String hint, OnOperaClickedListener listener) {
        this(context, title, hint, -1, listener);
    }

    public EditSingleLineDialog(Context context, String title, int inputType, OnOperaClickedListener listener) {
        this(context, title, null, null, inputType, listener);
    }

    public EditSingleLineDialog(Context context, String title, String hint, int inputType, OnOperaClickedListener listener) {
        this(context, title, null, hint, inputType, listener);
    }

    public EditSingleLineDialog(Context context, String title, String value, String hint, int inputType, OnOperaClickedListener listener) {
