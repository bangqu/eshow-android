...
public class BannerView extends FrameLayout {
    ...
    private static long LOOP_INTERVAL = 3000; //切换间隔
    ...
    private static class BannerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (bannerView == null || bannerView.mViewPager == null || bannerView.mViewPager.getAdapter() == null
...
//                        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                        ...
                        img.setBackgroundResource(R.drawable.point_gray);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.point_blue);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.point_gray);
                }
            }
        }
    }
